...
module.exports = function(router) {
    ...
    router.post('/users', function(req, res) {
        ...
        user.type_client = req.body.type_client;
        ...
        if (req.body.username === null || req.body.username === '' || req.body.password === null || req.body.password === '' || req.body.email === null || req.body.email === '' || req.body.name === null || req.body.name === ''
             || req.body.adresse === null || req.body.adresse === '' || req.body.phone === null || req.body.phone === '') {
            ...
            user.save(function(err) {
                if (err) {
                    ...
                    if (err.errors !== null) {
                        ...
                        } else if (err.errors.adresse) {
                            res.json({ success: false, message: err.errors.adresse.message }); 
     ...
     router.post('/chaines', function(req, res) {
        ...
        chaine.picture = req.body.picture; // Save password from request to User object
        chaine.bouquet = req.body.bouquet; // Save email from request to User object
        chaine.recepteur = req.body.frequence; // Save name from request to User object
      // Create a token for activating account through e-mail

        // Check if request is valid and not empty or null
        if (req.body.nomchaine == null || req.body.nomchaine == '' || req.body.picture == null || req.body.picture == '' || req.body.bouquet == null || req.body.bouquet == '' || req.body.recepteur == null || req.body.recepteur == '') {
            res.json({ success: false, message: 'Ensure nomchaine, bouquet,  and recepteur were provided' });
        } else {
            // Save new user to database
            chaine.save();
 ...
 // Route to get all users for management page
    router.get('/managemente', function(req, res) {
        Chaine.find({}, function(err, chaines) {
          ...
          if (!chaines) {
                                    res.json({ success: false, message: 'Chaine not found' }); // Return error
                                } else {
     ...
     router.get('/managementhistory', function(req, res) {
        History.find({}, function(err, historys) {
          if (!historys) {
                                    res.json({ success: false, message: 'History not found' }); // Return error
                                } else {
