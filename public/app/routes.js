...
.config(function($routeProvider, $locationProvider) {
    ...
    .when('/searchchaine', {
        templateUrl: 'app/views/pages/managemente/searchchaine.html',
        controller: 'managementeCtrl',
        controllerAs: 'managemente',
        authenticated: true,
        permission: ['admin']
    ...
    .when('/managemente', {
        templateUrl: 'app/views/pages/managemente/managemente.html',  
        controller: 'managementeCtrl', 
        controllerAs: 'managemente',
        authenticated: true,
        permission: ['admin']
    ...
    .when('/managementabonnement', {
        templateUrl: 'app/views/pages/abonnements/index.html',
